...
class Consulta_ApiSamsung extends bd
{
    ...
    private function get_body_so()
    {
        ...
        $Request_array = [
            'IsModelInfo' =>
            [
                'Model' => 'SGH-C516DSACHE',
                'ModelVersion' => 'CN02',
                'SerialNo' => 'R3TP931643B',
                'IMEI' => '354961011328718',
    ...
    private function get_body_changeSo()
    {
        ...
        $Request_array = [
            ...
            [
                ...
                'UnitSendToCustTime' => '',
                'ShipCarrier' => 'SHC001',
                'ShipOutTrackingNo' => '1942062',
                'ShipInTrackingNo' => '1942062',
                'RepairReqDate' => '',
                'ShopGiDate' => '',
                'ShopGrDate' => '',
                'CustReturnDate' => '',
            ...
            [
                'CustomerCode' => '6400003520',
                'CustHomePhone' => '91234567',
                'CustMobilePhone' => '91234568',
            ...
            'IsDateInfo' =>
            [
                'RequestDate' => '20200108',//$this->RequestDate,
                'RequestTime' => '100000',//$this->RequestTime
                'UnitRcvDate' => '20200108',//$this->RequestDate
                'UnitRcvTime' => '100000',//$this->RequestTime
                'FirstAppDate' => '',
                'FirstAppTime' => '',
                'LastAppDate' => '',
                'LastAppTime' => '',
    ...
    private function get_body_ChangeSoDelivery(){
       ...
       $this->postdata= json_encode([
        "IsInputValue"=>[
            'RepairReqDate' => '20200109 (YYYYMMDD)',//$this->RequestDate,
            'RepairReqTime' => '100000 (HHMISS)',//$this->RequestTime
            'ShopGiDate' => '20200109 (YYYYMMDD)',//$this->RequestDate
            'ShopGiTime' => '100000 (HHMISS)',//$this->RequestTime
            'UnitReceivedDate' => '',
            'UnitReceivedTime' => '',
            'UnitSendToAscDate' => '',
            'UnitSendToAscTime' => '',
